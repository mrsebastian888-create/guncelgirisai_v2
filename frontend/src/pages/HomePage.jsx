          ...
          <div className="container mx-auto max-w-7xl">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link to={`/${firmSlug}`} className="hover:text-[var(--neon-green)] transition-colors">
                        <h3 className="font-heading font-bold text-sm tracking-tight truncate" style={{ color: "var(--foreground)" }}>{firm.name}</h3>
                      </Link>
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="font-heading font-black text-sm" style={{ color: "var(--neon-green)" }}>{firm.bonus_amount}</span>
                    ...
                    <a href={firm.affiliate_url} target="_blank" rel="noopener noreferrer" data-testid={`firma-cta-${i}`}
                      ...
                      style={{ background: "transparent", color: "#00FF87", borderColor: "#00FF87" }}>
            ...
            {filteredFirms.length > 30 && (
              <div className="text-center mt-6">
                <button onClick={() => setShowAllFirms(!showAllFirms)} data-testid="firma-show-more-btn"
